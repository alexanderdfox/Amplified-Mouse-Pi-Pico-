...
def write_config_h(num_mice: int, logic_mode: int, input_mode: int, amplify: float, quad_scale: int) -> None:
...
def main() -> None:
    ...
    write_config_h(num_mice, logic_mode, input_mode, amplify, quad_scale)
